...
def run(path_summarised_output_folder, path_avg_replicate_output_folder):
    print(Fore.MAGENTA + "\nCalculating the average rpm / unique tag for each isomiR across multiple replicates...")
